  ...
  return (
    <div className="timer_ui">
      ...
      <div className="buttons_block">
        <TimerButton onClick={startStopwatch}>
          <svg width="60px" height="60px" viewBox="0 0 234 256">
            <path
        ...
        <TimerButton onClick={resetStopwatch}>
          <svg
            width="100px"
            height="100px"
            viewBox="-9 -7 34 34"
